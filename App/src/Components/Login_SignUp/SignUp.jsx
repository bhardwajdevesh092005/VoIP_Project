    ...
    <div className="h-full flex flex-col items-center justify-center px-4">
      ...
      <div>
        ...
        <div className="flex items-center px-3 py-2 border border-gray-300 rounded-md bg-gray-100">
          ...
          >
            {showPassword ? <img className="w-7 h-7" src="eye-close.svg" /> : <img className="w-7 h-7" src="/eye-open.svg" />}
          </button>
        </div>
      ...
      <div>
        ...
        <div className="flex items-center px-3 py-2 border border-gray-300 rounded-md bg-gray-100">
          ...
          <button
            ...
            className="text-gray-500 focus:outline-none ml-2"
          >
            {showConfirmPassword ? <img className="w-7 h-7" src="eye-close.svg" /> : <img className="w-7 h-7" src="/eye-open.svg" />}
          </button>
        </div>
